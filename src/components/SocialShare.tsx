export function SocialShare({ url, text }: { url: string; text: string }) {
  const SOCIALS = [
    ...
    {
      link: `https://facebook.com/sharer/sharer.php?u=${url}&quote=${text}`,
      icon: (
        <svg
          width={16}
          height={16}
    ...
    {
      link: `fb-messenger://share/?link=${url}&app_id=1234567890&quote=${text}`,
      icon: (
        <svg
          width={16}
          height={16}
      ...
      <div className="flex gap-2">
        {SOCIALS.map((social) => (
          <a
            ...
            aria-label={`แชร์ผ่าน ${social.link}`}
          >
            {social.icon}
          </a>
        ))}
