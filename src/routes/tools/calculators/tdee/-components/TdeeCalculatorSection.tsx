...
const ACTIVITY_LEVELS = [
  ...
  { value: 1.375, label: "ออกกำลังกายเบาๆ (1–2 วัน/สัปดาห์)" },
...
export function TdeeCalculatorSection({
  ...
  const {
    ...
    defaultValues: {
      ...
      weightUnit: "kilogram" as "kilogram" | "pound",
      heightUnit: "centimeter" as "centimeter" | "meter",
  ...
  return (
    <section>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="space-y-2">
          <label className="block">ระดับกิจกรรม</label>
          <select
